 ...
 * A person is considered unique by comparing using {@code Person#isSameResident(Person)}. As such, adding and updating of
 * persons uses Person#isSameResident(Person) for equality so as to ensure that the person being added or updated is
