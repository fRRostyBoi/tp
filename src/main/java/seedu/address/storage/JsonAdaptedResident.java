...
class JsonAdaptedResident {
    ...
    public JsonAdaptedResident(Resident source) {
        ...
        address = source.getUnitNumber().value;
    ...
    public Resident toModelType() throws IllegalValueException {
        ...
        if (!UnitNumber.isValidUnitNumber(address)) {
            throw new IllegalValueException(UnitNumber.MESSAGE_CONSTRAINTS);
        }
        final UnitNumber modelUnitNumber = new UnitNumber(address);

        final Set<Tag> modelTags = new HashSet<>(personTags);
        return new Resident(modelName, modelPhone, modelEmail, modelUnitNumber, modelTags);
    }
